      ...
      <Card className="w-full max-w-md border-t-4 border-t-blue-600 shadow-xl bg-white dark:bg-zinc-900">
        ...
        <CardContent className="space-y-5 pt-2">
          ...
          <form action={formAction} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5" disabled={isPending}>
          ...
          <div className="pt-3 border-t border-zinc-100 dark:border-zinc-800">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button
                ...
                variant="outline"
                size="xs"
                onClick={() => handleDemoFill('admin@refugia.org')}
              ...
              <Button
                ...
                variant="outline"
                size="xs"
                onClick={() => handleDemoFill('social@refugia.org')}
